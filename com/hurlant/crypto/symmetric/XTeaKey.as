package com.hurlant.crypto.symmetric
{
   ...
   public class XTeaKey implements ISymmetricKey
   {
      ...
      public function encrypt(param1:ByteArray, param2:uint = 0) : void
      {
         ...
         {
            _loc3_ = _loc3_ + ((_loc4_ << 4 ^ _loc4_ >> 5) + _loc4_ ^ _loc6_ + k[_loc6_ & 3]);
            _loc6_ = _loc6_ + _loc7_;
            _loc4_ = _loc4_ + ((_loc3_ << 4 ^ _loc3_ >> 5) + _loc3_ ^ _loc6_ + k[_loc6_ >> 11 & 3]);
            _loc5_++;
         }
      ...
      public function decrypt(param1:ByteArray, param2:uint = 0) : void
      {
         ...
         _loc4_ = param1.readUnsignedInt();
         _loc6_ = 2654435769;
         _loc7_ = _loc6_ * NUM_ROUNDS;
         _loc5_ = 0;
         while(_loc5_ < NUM_ROUNDS)
         {
            _loc4_ = _loc4_ - ((_loc3_ << 4 ^ _loc3_ >> 5) + _loc3_ ^ _loc7_ + k[_loc7_ >> 11 & 3]);
            _loc7_ = _loc7_ - _loc6_;
            _loc3_ = _loc3_ - ((_loc4_ << 4 ^ _loc4_ >> 5) + _loc4_ ^ _loc7_ + k[_loc7_ & 3]);
            _loc5_++;
         }
         param1.position = param1.position - 8;
         param1.writeUnsignedInt(_loc3_);
