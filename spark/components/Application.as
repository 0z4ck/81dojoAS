   ...
   public class Application extends SkinnableContainer
   {
      ...
      public function get applicationDPI() : Number
      {
         ...
         if(isNaN(this._applicationDPI))
         {
            ...
            this._applicationDPI = !!_loc1_?Number(Number(_loc1_)):Number(this.runtimeDPI);
         }
      ...
      public function get aspectRatio() : String
      {
         ...
         if(this.isSoftKeyboardActive && softKeyboardBehavior == "none" && this.resizeForSoftKeyboard)
         {
            _loc1_ = _loc1_ + stage.softKeyboardRect.height;
         }
      ...
      override public function initialize() : void
      {
         ...
         if(this.isIOS && _loc1_ && _loc1_.stage && _loc1_.isTopLevelRoot())
         {
      ...
      private function stage_orientationChangingHandler(param1:Event) : void
      {
         ...
         {
            _loc6_ = this.cachedDimensions[_loc3_].width;
            _loc7_ = this.cachedDimensions[_loc3_].height;
         }
         else
         {
            _loc6_ = !!stage?Number(stage.stageHeight / this.scaleFactor):Number(height);
            _loc7_ = width;
         }
      ...
      override protected function createChildren() : void
      {
         ...
         if(softKeyboardBehavior != "")
         {
            ...
            if(_loc1_ && _loc1_["nativeApplication"])
            {
      ...
      private function initResizeBehavior() : void
      {
         ...
         this.synchronousResize = (parseFloat(_loc1_[0]) > 10 || parseFloat(_loc1_[0]) == 10 && parseFloat(_loc1_[1]) >= 1) && (Capabilities.playerType != "Desktop" || _loc3_);
      }
      ...
      private function softKeyboardActivateHandler(param1:SoftKeyboardEvent) : void
      {
         ...
         {
            if(this.softKeyboardTarget && this.softKeyboardTarget != param1.target)
            {
            ...
            {
               _loc3_ = (stage.stageHeight - _loc2_.height) / this.scaleFactor;
               _loc4_ = stage.stageWidth / this.scaleFactor;
      ...
      {
         if(param1 == UncaughtErrorEvent.UNCAUGHT_ERROR && systemManager)
         {
            systemManager.loaderInfo.uncaughtErrorEvents.addEventListener(UncaughtErrorEvent.UNCAUGHT_ERROR,this.uncaughtErrorRedispatcher);
         }
