package spark.components.supportClasses
{
   ...
   public class SkinnableComponent extends UIComponent
   {
      ...
      override public function set enabled(param1:Boolean) : void
      {
         ...
         super.mouseChildren = !!param1?Boolean(this._explicitMouseChildren):false;
         super.mouseEnabled = !!param1?Boolean(this._explicitMouseEnabled):false;
      }
      ...
      override public function drawFocus(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            if(this.focusObj && "target" in this.focusObj)
            {
      ...
      {
         if(this.dynamicPartsCache && this.dynamicPartsCache[param1])
         {
      ...
      {
         if(!param1 || !validateBaselinePosition())
         {
