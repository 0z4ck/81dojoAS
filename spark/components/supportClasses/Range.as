package spark.components.supportClasses
{
   ...
   public class Range extends SkinnableComponent
   {
      ...
      {
         return !!this.valueChanged?Number(this._changedValue):Number(this._value);
      }
      ...
      override protected function commitProperties() : void
      {
         ...
         {
            _loc1_ = !!this.valueChanged?Number(this._changedValue):Number(this._value);
      ...
      private function nearestValidSize(param1:Number) : Number
      {
         ...
         return Math.abs(_loc3_) < _loc2_?Number(_loc2_):Number(_loc3_);
      }
      ...
      protected function nearestValidValue(param1:Number, param2:Number) : Number
      {
         ...
         var _loc7_:Number = param1 - _loc5_ >= (_loc6_ - _loc5_) / 2?Number(_loc6_):Number(_loc5_);
      ...
      public function changeValueByStep(param1:Boolean = true) : void
      {
         ...
         var _loc2_:Number = !!param1?Number(this.value + this.stepSize):Number(this.value - this.stepSize);
