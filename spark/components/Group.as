package spark.components
{
   ...
   public class Group extends GroupBase implements IVisualElementContainer, IGraphicElementContainer, ISharedDisplayObject
   {
      ...
      override mx_internal function set hasMouseListeners(param1:Boolean) : void
      {
         ...
         super.hasMouseListeners = param1;
      }
      ...
      private function setMXMLContent(param1:Array) : void
      {
         ...
         if(this._mxmlContent != null && this._mxmlContent != param1)
         {
            ...
            while(_loc2_ >= 0)
            {
               this.elementRemoved(this._mxmlContent[_loc2_],_loc2_);
               _loc2_--;
            }
         }
         ...
         if(this._mxmlContent != null)
         {
            ...
            while(_loc2_ < _loc3_)
            {
               _loc4_ = this._mxmlContent[_loc2_];
               if(_loc4_.parent && _loc4_.parent != this)
               {
                  throw new Error(resourceManager.getString("components","mxmlElementNoMultipleParents",[_loc4_]));
               }
               this.elementAdded(_loc4_,_loc2_);
               _loc2_++;
            }
         }
      }
      ...
      override public function validateProperties() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:IGraphicElement = null;
      ...
      override public function validateSize(param1:Boolean = false) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:IGraphicElement = null;
         if(this.numGraphicElements > 0)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.getElementAt(_loc3_) as IGraphicElement;
               if(_loc4_)
               {
                  _loc4_.validateSize();
               }
      ...
      override public function validateDisplayList() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:IGraphicElement = null;
         var _loc5_:ISharedDisplayObject = null;
         ...
         if(this.numGraphicElements > 0)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               if(_loc4_)
               {
                  ...
                  {
                     _loc5_ = _loc4_.displayObject as ISharedDisplayObject;
                     if(!_loc5_ || _loc5_.redrawRequested)
                     {
                        _loc4_.validateDisplayList();
                        if(_loc5_)
                        {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.scaleGridChanged)
         {
            ...
            if(this.isValidScaleGrid())
            {
               _loc4_ = !!_overlay?int(_overlay.numDisplayObjects):0;
      ...
      override public function notifyStyleChangeInChildren(param1:String, param2:Boolean) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:IAdvancedStyleClient = null;
         ...
         while(_loc4_ < _loc3_)
         {
            _loc5_ = this.getElementAt(_loc4_) as ISimpleStyleClient;
            if(_loc5_)
            {
         ...
         {
            for(_loc6_ in advanceStyleClientChildren)
            {
               _loc7_ = _loc6_ as IAdvancedStyleClient;
               if(_loc7_)
               {
      ...
      override public function regenerateStyleCache(param1:Boolean) : void
      {
         var _loc4_:IVisualElement = null;
         var _loc5_:* = null;
         var _loc6_:IAdvancedStyleClient = null;
         initProtoChain();
         var _loc2_:int = this.numElements;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.getElementAt(_loc3_);
            if(_loc4_ is IStyleClient)
            {
         ...
         if(advanceStyleClientChildren != null)
         {
            for(_loc5_ in advanceStyleClientChildren)
            {
               _loc6_ = _loc5_ as IAdvancedStyleClient;
               if(_loc6_ && _loc6_.inheritingStyles != StyleProtoChain.STYLE_UNINITIALIZED)
               {
      ...
      {
         var _loc3_:int = this._mxmlContent == null?-1:int(this._mxmlContent.length - 1);
         if(param2)
         {
            _loc3_++;
         }
      ...
      public function addElementAt(param1:IVisualElement, param2:int) : IVisualElement
      {
         ...
         if(!this.mxmlContentChanged)
         {
            this.elementAdded(param1,param2);
         }
         this.scaleGridChanged = true;
         return param1;
      }
      ...
      public function removeElementAt(param1:int) : IVisualElement
      {
         ...
         if(!this.mxmlContentChanged)
         {
            this.elementRemoved(_loc2_,param1);
         }
      ...
      {
         var _loc2_:int = !!this._mxmlContent?int(this._mxmlContent.indexOf(param1)):-1;
         if(_loc2_ == -1)
         {
      ...
      public function swapElementsAt(param1:int, param2:int) : void
      {
         ...
         if(!this.mxmlContentChanged)
         {
            this.elementRemoved(_loc3_,param1,false);
            this.elementRemoved(_loc4_,param2,false);
         }
         ...
         if(!this.mxmlContentChanged)
         {
            this.elementAdded(_loc4_,param1,false);
            this.elementAdded(_loc3_,param2,false);
         }
      }
      ...
      mx_internal function elementAdded(param1:IVisualElement, param2:int, param3:Boolean = true) : void
      {
         ...
         if(param1 is IGraphicElement)
         {
            ...
            this.addingGraphicElementChild(param1 as IGraphicElement);
            this.invalidateDisplayObjectOrdering();
         }
         ...
         if(param3)
         {
            ...
            if(param1 is IUIComponent && param1.hasEventListener(FlexEvent.ADD))
            {
      ...
      mx_internal function elementRemoved(param1:IVisualElement, param2:int, param3:Boolean = true) : void
      {
         ...
         if(param3)
         {
            ...
            if(param1 is IUIComponent && param1.hasEventListener(FlexEvent.REMOVE))
            {
               param1.dispatchEvent(new FlexEvent(FlexEvent.REMOVE));
            }
         }
         if(param1 && param1 is IGraphicElement)
         {
            this.numGraphicElements--;
            this.removingGraphicElementChild(param1 as IGraphicElement);
         }
         else if(_loc4_ && _loc4_.parent == this)
         {
      ...
      {
         if(param1.displayObject && param1.displayObjectSharingMode == DisplayObjectSharingMode.USES_SHARED_OBJECT)
         {
      ...
      {
         this.discardDisplayObject(param1);
      ...
      {
         var _loc1_:Vector.<IVisualElement> = null;
      ...
      {
         var _loc4_:IGraphicElement = null;
         var _loc5_:IGraphicElement = null;
      ...
      {
         var _loc3_:int = !!_overlay?int(_overlay.numDisplayObjects):0;
         if(param1.parent == this)
         {
            super.setChildIndex(param1,param2 != -1?int(param2):int(super.numChildren - 1 - _loc3_));
         }
         else
         {
            super.addChildAt(param1,param2 != -1?int(param2):int(super.numChildren - _loc3_));
         }
      }
