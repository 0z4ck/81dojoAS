package spark.primitives
{
   ...
   public class Rect extends FilledElement
   {
      ...
      override public function setLayoutBoundsSize(param1:Number, param2:Number, param3:Boolean = true) : void
      {
         ...
         var _loc4_:Boolean = !isNaN(this.topLeftRadiusX) || !isNaN(this.topRightRadiusX) || !isNaN(this.bottomLeftRadiusX) || !isNaN(this.bottomRightRadiusX) || this.radiusX != 0 || this.radiusY != 0;
         if(!_loc4_)
         {
            return;
         }
