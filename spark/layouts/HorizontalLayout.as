   ...
   public class HorizontalLayout extends LayoutBase
   {
      ...
      private static function calculatePercentHeight(param1:ILayoutElement, param2:Number) : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_6)
         {
            ...
            return _loc3_ < param2?Number(_loc3_):Number(param2);
         }
         _loc3_ = LayoutElementHelper.pinBetween(Math.min(Math.round(param1.percentHeight * 0.01 * param2),param2),param1.getMinBoundsHeight(),param1.getMaxBoundsHeight());
         return _loc3_;
      }
      ...
      private static function findIndexAt(param1:Number, param2:int, param3:GroupBase, param4:int, param5:int) : int
      {
         ...
         var _loc7_:ILayoutElement = param3.getElementAt(_loc6_);
         var _loc8_:Number = _loc7_.getLayoutBoundsX();
      ...
      private static function findLayoutElementIndex(param1:GroupBase, param2:int, param3:int) : int
      {
         ...
         {
            _loc5_ = param1.getElementAt(param2);
      ...
      {
         var _loc1_:ILayoutElement = null;
         if(!isNaN(this._columnWidth))
         {
            return this._columnWidth;
         }
         _loc1_ = typicalLayoutElement;
         return !!_loc1_?Number(_loc1_.getPreferredBoundsWidth()):Number(0);
      }
      ...
      public function fractionOfElementInView(param1:int) : Number
      {
         ...
         {
            _loc11_ = _loc2_.getElementAt(param1);
         ...
         var _loc7_:Number = _loc2_.horizontalScrollPosition;
         var _loc8_:Number = _loc7_ + _loc2_.width;
      ...
      override protected function scrollPositionChanged() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:ILayoutElement = null;
         var _loc14_:Number = NaN;
         var _loc15_:Number = NaN;
         var _loc16_:ILayoutElement = null;
         var _loc17_:ILayoutElement = null;
         ...
         var _loc5_:Number = _loc3_.right - 0.0001;
         if(_loc5_ <= _loc4_)
         {
            this.setIndexInView(-1,-1);
            return;
         ...
         if(_loc6_ == -1)
         {
            _loc8_ = findLayoutElementIndex(_loc1_,0,1);
            if(_loc8_ != -1)
            {
               _loc9_ = _loc1_.getElementAt(_loc8_);
               _loc10_ = _loc9_.getLayoutBoundsX();
         ...
         if(_loc7_ == -1)
         {
            _loc12_ = findLayoutElementIndex(_loc1_,_loc2_,-1);
            if(_loc12_ != -1)
            {
               _loc13_ = _loc1_.getElementAt(_loc12_);
               _loc14_ = _loc13_.getLayoutBoundsX();
      ...
      private function findLayoutElementBounds(param1:GroupBase, param2:int, param3:int, param4:Rectangle) : Rectangle
      {
         ...
         {
            _loc6_ = this.getElementBounds(param2);
            if(_loc6_)
            {
      ...
      private function getElementWidth(param1:ILayoutElement, param2:Number, param3:SizesAndLimit#64) : void
      {
         var _loc4_:Number = !!isNaN(param2)?Number(Math.ceil(param1.getPreferredBoundsWidth())):Number(param2);
         var _loc5_:* = !isNaN(param1.percentWidth);
         var _loc6_:Number = !!_loc5_?Number(Math.ceil(param1.getMinBoundsWidth())):Number(_loc4_);
         param3.preferredSize = _loc4_;
         param3.minSize = _loc6_;
      }
      
      private function getElementHeight(param1:ILayoutElement, param2:Boolean, param3:SizesAndLimit#64) : void
      {
         var _loc4_:Number = Math.ceil(param1.getPreferredBoundsHeight());
         var _loc5_:Boolean = !isNaN(param1.percentHeight) || param2;
         var _loc6_:Number = !!_loc5_?Number(Math.ceil(param1.getMinBoundsHeight())):Number(_loc4_);
         param3.preferredSize = _loc4_;
         param3.minSize = _loc6_;
      }
      ...
      private function calculateBaselineTopBottom(param1:Boolean) : Array
      {
         ...
         var _loc4_:Number = 0;
         var _loc5_:Number = 0;
         var _loc7_:Array = LayoutElementHelper.parseConstraintExp(this.alignmentBaseline);
         if(_loc7_.length == 2 && _loc7_[1] == "maxAscent")
         {
         ...
         var _loc8_:int = target.numElements;
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
            _loc10_ = target.getElementAt(_loc9_);
            if(!(!_loc10_ || !_loc10_.includeInLayout))
            {
               ...
               _loc12_ = _loc10_.baselinePosition;
               ...
               if(param1)
               {
                  _loc14_ = _loc10_.getPreferredBoundsHeight();
      ...
      private function measureReal(param1:GroupBase) : void
      {
         ...
         var _loc2_:SizesAndLimit = new SizesAndLimit#64();
         ...
         {
            _loc15_ = param1.getElementAt(_loc16_);
            ...
            else
            {
               ...
               if(_loc8_ < _loc14_)
               {
                  ...
                  _loc10_ = _loc10_ + _loc2_.preferredSize;
                  _loc12_ = _loc12_ + _loc2_.minSize;
                  _loc8_++;
               }
            }
            _loc16_++;
         ...
         if(_loc8_ < _loc14_)
         {
            ...
            if(_loc15_)
            {
               ...
               this.getElementWidth(_loc15_,_loc13_,_loc2_);
               _loc10_ = _loc10_ + _loc2_.preferredSize * (_loc14_ - _loc8_);
               _loc12_ = _loc12_ + _loc2_.minSize * (_loc14_ - _loc8_);
               _loc8_ = _loc14_;
            }
         }
         if(_loc3_)
         {
            _loc19_ = this.calculateBaselineTopBottom(true);
            _loc20_ = _loc19_[0];
            _loc21_ = _loc19_[1];
            _loc22_ = _loc19_[2];
      ...
      {
         if(param1 >= 0 && useVirtualLayout && this.llv)
         {
      ...
      private function measureVirtual(param1:GroupBase) : void
      {
         ...
         if(this.variableColumnWidth)
         {
            ...
            _loc8_ = param1 as DataGroup;
            if(_loc8_)
            {
               _loc9_ = _loc8_.getItemIndicesInView();
               for each(_loc10_ in _loc9_)
               {
                  _loc11_ = _loc8_.getElementAt(_loc10_);
                  if(_loc11_)
                  {
                     _loc7_ = _loc7_ - this.llv.getMajorSize(_loc10_);
                     _loc7_ = _loc7_ + _loc11_.getPreferredBoundsWidth();
                  }
               }
            }
         ...
         {
            _loc12_ = _loc3_ > 1?Number((_loc3_ - 1) * this.gap):Number(0);
         ...
         param1.measuredMinHeight = this.verticalAlign == VerticalAlign.JUSTIFY?Number(this.llv.minMinorSize + _loc5_):Number(param1.measuredHeight);
      }
         ...
         switch(param2)
         {
            ...
            case NavigationUnit.PAGE_LEFT:
               ...
               else
               {
                  ...
                  while(0 <= _loc5_)
                  {
                     _loc6_ = this.getElementBounds(_loc5_);
                     if(_loc6_ && _loc6_.left < _loc7_)
                     {
      ...
      private function updateDisplayListVirtual() : void
      {
         var _loc6_:Number = NaN;
         var _loc7_:Number = NaN;
         var _loc21_:ILayoutElement = null;
         var _loc22_:Number = NaN;
         var _loc23_:Number = NaN;
         ...
         var _loc4_:Number = _loc1_.horizontalScrollPosition;
         var _loc5_:Number = _loc4_ + _loc1_.width;
         this.updateLLV(_loc1_);
         var _loc8_:int = this.llv.indexOf(Math.max(0,_loc4_ + this.gap));
         if(_loc8_ == -1)
         {
         ...
         var _loc11_:Number = NaN;
         var _loc12_:Number = !!_loc10_?Number(Math.max(this.llv.minMinorSize,_loc3_)):Number(this.llv.minorSize);
         var _loc13_:Number = !!_loc10_?Number(Math.max(this.llv.minMinorSize,_loc3_)):Number(this.llv.minorSize);
         ...
         while(_loc15_ < _loc5_ && _loc16_ < _loc2_)
         {
            ...
            _loc15_ = _loc15_ + (_loc22_ + this.gap);
            _loc16_++;
         }
         ...
         if(_loc6_ < _loc19_)
         {
            ...
            _loc26_ = 0;
            _loc27_ = this.horizontalAlign;
            if(_loc27_ == HorizontalAlign.CENTER)
            {
            ...
            if(_loc26_ > 0)
            {
               ...
               {
                  _loc21_ = _loc1_.getElementAt(_loc16_);
                  _loc21_.setLayoutBoundsPosition(_loc26_ + _loc21_.getLayoutBoundsX(),_loc21_.getLayoutBoundsY());
                  _loc16_++;
               }
               _loc6_ = _loc6_ + _loc26_;
            }
         }
      ...
      private function updateDisplayListReal() : void
      {
         ...
         if(this.verticalAlign == VerticalAlign.CONTENT_JUSTIFY || clipAndEnableScrolling && (this.verticalAlign == VerticalAlign.MIDDLE || this.verticalAlign == VerticalAlign.BOTTOM))
         {
            ...
            {
               _loc4_ = _loc1_.getElementAt(_loc21_);
         ...
         if(_loc10_)
         {
            _loc23_ = this.calculateBaselineTopBottom(false);
            _loc9_ = _loc23_[0];
         }
         var _loc11_:uint = 0;
         var _loc12_:Number = _loc1_.horizontalScrollPosition;
         var _loc13_:Number = _loc12_ + _loc2_;
         ...
         {
            _loc24_ = this.horizontalAlign;
            if(_loc24_ == HorizontalAlign.CENTER)
            {
         ...
         {
            _loc4_ = _loc1_.getElementAt(_loc20_);
            if(!(!_loc4_ || !_loc4_.includeInLayout))
            {
               ...
               _loc14_ = _loc14_ + (_loc25_ + this.gap);
            }
            _loc20_++;
         }
      ...
      {
         var _loc7_:HLayoutElementFlexChildInfo = null;
         var _loc8_:Number = NaN;
         var _loc9_:ILayoutElement = null;
         var _loc14_:Number = NaN;
         var _loc15_:int = 0;
         ...
         var _loc5_:Number = 0;
         var _loc6_:Array = [];
         var _loc10_:Number = !!this.variableColumnWidth?Number(0):Number(Math.ceil(this.columnWidth));
         var _loc11_:int = target.numElements;
         var _loc12_:int = _loc11_;
         var _loc13_:int = 0;
         while(_loc13_ < _loc11_)
         {
            _loc9_ = target.getElementAt(_loc13_);
            ...
            {
               _loc5_ = _loc5_ + _loc9_.percentWidth;
               _loc7_ = new HLayoutElementFlexChildInfo();
               _loc7_.layoutElement = _loc9_;
            ...
            else
            {
               ...
               _loc4_ = _loc4_ - Math.ceil(_loc9_.getLayoutBoundsWidth());
            }
            _loc13_++;
         }
         if(_loc12_ > 1)
         {
            _loc4_ = _loc4_ - (_loc12_ - 1) * this.gap;
         }
         if(_loc5_)
         {
            ...
            for each(_loc7_ in _loc6_)
            {
               ...
               _loc14_ = _loc14_ + (_loc7_.size - _loc15_);
      ...
      override protected function calculateDropIndex(param1:Number, param2:Number) : int
      {
         ...
         while(_loc9_ <= _loc8_)
         {
            _loc10_ = this.getElementBounds(_loc9_);
            if(_loc10_)
            {
               if(_loc10_.left <= param1 && param1 <= _loc10_.right)
               {
                  _loc12_ = _loc10_.x + _loc10_.width / 2;
                  return param1 < _loc12_?int(_loc9_):int(_loc9_ + 1);
               }
               _loc11_ = Math.min(Math.abs(param1 - _loc10_.left),Math.abs(param1 - _loc10_.right));
               if(_loc11_ < _loc5_)
               {
                  _loc5_ = _loc11_;
                  _loc6_ = param1 < _loc10_.left?int(_loc9_):int(_loc9_ + 1);
               }
            }
            _loc9_++;
         }
         if(_loc6_ == -1)
         {
            _loc6_ = this.getElementBounds(0).x < param1?int(_loc4_):0;
         }
         return _loc6_;
      }
      ...
      override protected function calculateDropIndicatorBounds(param1:DropLocation) : Rectangle
      {
         ...
         var _loc3_:int = target.numElements;
         var _loc4_:Number = this.gap;
         if(_loc4_ < 0 && _loc2_ == _loc3_)
         {
            _loc4_ = 0;
         }
         var _loc5_:Number = 0 < _loc4_?Number(_loc4_):Number(0);
         var _loc6_:Number = 0;
         if(target.numElements > 0)
         {
            _loc6_ = _loc2_ < _loc3_?Number(this.getElementBounds(_loc2_).left - _loc5_):Number(this.getElementBounds(_loc2_ - 1).right + _loc4_ - _loc5_);
         }
         ...
         _loc9_ = Math.max(-Math.ceil(_loc7_ / 2),Math.min(target.contentWidth - Math.ceil(_loc7_ / 2),_loc9_));
      ...
      override mx_internal function getElementNearestScrollPosition(param1:Point, param2:String = "center") : int
      {
         ...
         if(!useVirtualLayout)
         {
            return super.getElementNearestScrollPosition(param1,param2);
         }
         ...
         var _loc4_:int = this.llv.indexOf(param1.x);
         if(_loc4_ == -1)
         {
            _loc4_ = param1.x < 0?0:int(_loc3_.numElements - 1);
         }
