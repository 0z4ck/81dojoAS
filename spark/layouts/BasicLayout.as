package spark.layouts
{
   ...
   public class BasicLayout extends LayoutBase
   {
      ...
      override public function measure() : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            if(!(!_loc8_ || !_loc8_.includeInLayout))
            {
               ...
               {
                  _loc16_ = !!isNaN(_loc12_)?Number(0):Number(_loc12_);
                  _loc16_ = _loc16_ + (!!isNaN(_loc13_)?0:_loc13_);
               }
               else
               {
               ...
               {
                  _loc17_ = !!isNaN(_loc14_)?Number(0):Number(_loc14_);
                  _loc17_ = _loc17_ + (!!isNaN(_loc15_)?0:_loc15_);
               }
               else
               {
               ...
               _loc20_ = !!constraintsDetermineWidth(_loc8_)?Number(_loc8_.getMinBoundsWidth()):Number(_loc18_);
               _loc21_ = !!constraintsDetermineHeight(_loc8_)?Number(_loc8_.getMinBoundsHeight()):Number(_loc19_);
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         while(_loc7_ < _loc4_)
         {
            _loc8_ = _loc3_.getElementAt(_loc7_);
            if(!(!_loc8_ || !_loc8_.includeInLayout))
            {
               _loc9_ = LayoutElementHelper.parseConstraintValue(_loc8_.horizontalCenter);
               _loc10_ = LayoutElementHelper.parseConstraintValue(_loc8_.verticalCenter);
               ...
               if(!isNaN(_loc16_))
               {
                  ...
                  if(!isNaN(_loc12_))
                  {
                     _loc26_ = _loc26_ - _loc12_;
                  }
                  if(!isNaN(_loc13_))
                  {
                     _loc26_ = _loc26_ - _loc13_;
                  }
               ...
               {
                  _loc25_ = Math.round(_loc11_ - IVisualElement(_loc8_).baselinePosition);
               }
