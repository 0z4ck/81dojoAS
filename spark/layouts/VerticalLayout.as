package spark.layouts
{
   ...
   public class VerticalLayout extends LayoutBase
   {
      ...
      private static function calculatePercentWidth(param1:ILayoutElement, param2:Number) : Number
      {
         ...
         _loc3_ = LayoutElementHelper.pinBetween(Math.min(Math.round(param1.percentWidth * 0.01 * param2),param2),param1.getMinBoundsWidth(),param1.getMaxBoundsWidth());
         return _loc3_;
      }
      ...
      private static function findIndexAt(param1:Number, param2:int, param3:GroupBase, param4:int, param5:int) : int
      {
         ...
         var _loc8_:Number = _loc7_.getLayoutBoundsY();
      ...
      public function get rowHeight() : Number
      {
         ...
         return !!_loc1_?Number(_loc1_.getPreferredBoundsHeight()):Number(0);
      }
      ...
      public function fractionOfElementInView(param1:int) : Number
      {
         ...
         var _loc7_:Number = _loc2_.verticalScrollPosition;
         var _loc8_:Number = _loc7_ + _loc2_.height;
      ...
      override protected function scrollPositionChanged() : void
      {
         ...
         var _loc5_:Number = _loc3_.bottom - 0.0001;
         if(_loc5_ <= _loc4_)
         {
            this.setIndexInView(-1,-1);
            return;
         ...
         if(_loc6_ == -1)
         {
            ...
            if(_loc8_ != -1)
            {
               ...
               _loc10_ = _loc9_.getLayoutBoundsY();
         ...
         if(_loc7_ == -1)
         {
            ...
            if(_loc12_ != -1)
            {
               ...
               _loc14_ = _loc13_.getLayoutBoundsY();
      ...
      private function getElementWidth(param1:ILayoutElement, param2:Boolean, param3:SizesAndLimit#63) : void
      {
         var _loc4_:Number = Math.ceil(param1.getPreferredBoundsWidth());
         var _loc5_:Boolean = !isNaN(param1.percentWidth) || param2;
      ...
      private function getElementHeight(param1:ILayoutElement, param2:Number, param3:SizesAndLimit#63) : void
      {
         var _loc4_:Number = !!isNaN(param2)?Number(Math.ceil(param1.getPreferredBoundsHeight())):Number(param2);
      ...
      {
         var _loc14_:ILayoutElement = null;
         var _loc18_:Number = NaN;
         var _loc2_:SizesAndLimit = new SizesAndLimit#63();
         ...
         var _loc13_:int = this.getRowsToMeasure(_loc5_);
         var _loc15_:int = 0;
         while(_loc15_ < _loc4_)
         {
            _loc14_ = param1.getElementAt(_loc15_);
            if(!_loc14_ || !_loc14_.includeInLayout)
            {
               _loc5_--;
            }
            else
            {
               if(_loc7_ < _loc13_)
               {
                  ...
                  _loc8_ = _loc8_ + _loc2_.preferredSize;
                  _loc10_ = _loc10_ + _loc2_.minSize;
                  _loc7_++;
               }
         ...
         _loc13_ = this.getRowsToMeasure(_loc5_);
         if(_loc7_ < _loc13_)
         {
            _loc14_ = typicalLayoutElement;
            if(_loc14_)
            {
               this.getElementHeight(_loc14_,_loc12_,_loc2_);
               _loc8_ = _loc8_ + _loc2_.preferredSize * (_loc13_ - _loc7_);
               _loc10_ = _loc10_ + _loc2_.minSize * (_loc13_ - _loc7_);
               this.getElementWidth(_loc14_,_loc3_,_loc2_);
               _loc9_ = Math.max(_loc9_,_loc2_.preferredSize);
               _loc11_ = Math.max(_loc11_,_loc2_.minSize);
               _loc7_ = _loc13_;
      ...
      private function measureVirtual(param1:GroupBase) : void
      {
         ...
         var _loc3_:int = this.getRowsToMeasure(_loc2_);
            ...
            if(_loc8_)
            {
               ...
               for each(_loc10_ in _loc9_)
               {
                  ...
                  if(_loc11_)
                  {
                     ...
                     _loc7_ = _loc7_ + _loc11_.getPreferredBoundsHeight();
                  }
               }
            }
         ...
         param1.measuredMinWidth = this.horizontalAlign == HorizontalAlign.JUSTIFY?Number(this.llv.minMinorSize + _loc4_):Number(param1.measuredWidth);
         ...
         switch(param2)
         {
            ...
            case NavigationUnit.PAGE_DOWN:
               ...
               else
               {
                  ...
                  {
                     _loc6_ = this.getElementBounds(_loc5_);
                     if(_loc6_ && _loc6_.bottom > _loc7_)
                     {
      ...
      private function updateDisplayListVirtual() : void
      {
         ...
         var _loc4_:Number = _loc1_.verticalScrollPosition;
         var _loc5_:Number = _loc4_ + _loc1_.height;
         ...
         var _loc11_:Number = !!_loc10_?Number(_loc3_):Number(NaN);
         var _loc12_:Number = NaN;
         ...
         while(_loc15_ < _loc5_ && _loc16_ < _loc2_)
         {
            ...
            _loc15_ = _loc15_ + (_loc23_ + this.gap);
            _loc16_++;
         }
         ...
         if(_loc6_ < _loc19_)
         {
            ...
            _loc26_ = 0;
            _loc27_ = this.verticalAlign;
            if(_loc27_ == VerticalAlign.MIDDLE)
            {
         ...
         this.setRowCount(_loc16_ - _loc8_);
      ...
      private function updateDisplayListReal() : void
      {
         ...
         if(this.horizontalAlign == HorizontalAlign.CONTENT_JUSTIFY || clipAndEnableScrolling && (this.horizontalAlign == HorizontalAlign.CENTER || this.horizontalAlign == HorizontalAlign.RIGHT))
         {
            ...
            {
               _loc4_ = _loc1_.getElementAt(_loc19_);
         ...
         var _loc9_:uint = 0;
         var _loc10_:Number = _loc1_.verticalScrollPosition;
         var _loc11_:Number = _loc10_ + _loc3_;
         ...
         {
            _loc21_ = this.verticalAlign;
            if(_loc21_ == VerticalAlign.MIDDLE)
            {
         ...
         {
            _loc4_ = _loc1_.getElementAt(_loc18_);
            if(!(!_loc4_ || !_loc4_.includeInLayout))
            {
               ...
               _loc13_ = _loc13_ + (_loc23_ + this.gap);
            }
            _loc18_++;
         }
         this.setRowCount(_loc9_);
         this.setIndexInView(_loc16_,_loc17_);
      ...
      {
         var _loc7_:LayoutElementFlexChildInfo = null;
         ...
         var _loc5_:Number = 0;
         var _loc6_:Array = [];
         var _loc9_:Number = !!this.variableRowHeight?Number(0):Number(Math.ceil(this.rowHeight));
         var _loc10_:int = target.numElements;
         var _loc11_:int = _loc10_;
         var _loc12_:int = 0;
         while(_loc12_ < _loc10_)
         {
            _loc8_ = target.getElementAt(_loc12_);
            ...
            {
               _loc5_ = _loc5_ + _loc8_.percentHeight;
               _loc7_ = new LayoutElementFlexChildInfo();
               _loc7_.layoutElement = _loc8_;
            ...
            else
            {
               ...
               _loc4_ = _loc4_ - Math.ceil(_loc8_.getLayoutBoundsHeight());
            }
            _loc12_++;
         }
         if(_loc11_ > 1)
         {
            _loc4_ = _loc4_ - (_loc11_ - 1) * this.gap;
         }
         if(_loc5_)
         {
            ...
            for each(_loc7_ in _loc6_)
            {
               ...
               _loc13_ = _loc13_ + (_loc7_.size - _loc14_);
      ...
      override protected function calculateDropIndex(param1:Number, param2:Number) : int
      {
         ...
         while(_loc9_ <= _loc8_)
         {
            ...
            if(_loc10_)
            {
               if(_loc10_.top <= param2 && param2 <= _loc10_.bottom)
               {
                  ...
                  return param2 < _loc12_?int(_loc9_):int(_loc9_ + 1);
               }
               _loc11_ = Math.min(Math.abs(param2 - _loc10_.top),Math.abs(param2 - _loc10_.bottom));
               if(_loc11_ < _loc5_)
               {
                  _loc5_ = _loc11_;
                  _loc6_ = param2 < _loc10_.top?int(_loc9_):int(_loc9_ + 1);
               }
            }
            _loc9_++;
         }
         if(_loc6_ == -1)
         {
            _loc6_ = this.getElementBounds(0).y < param2?int(_loc4_):0;
         }
         return _loc6_;
      }
      ...
      override protected function calculateDropIndicatorBounds(param1:DropLocation) : Rectangle
      {
         ...
         {
            _loc6_ = _loc2_ < _loc3_?Number(this.getElementBounds(_loc2_).top - _loc5_):Number(this.getElementBounds(_loc2_ - 1).bottom + _loc4_ - _loc5_);
         }
         ...
         _loc10_ = Math.max(-1,Math.min(target.contentHeight - _loc8_ + 1,_loc10_));
      ...
      override mx_internal function getElementNearestScrollPosition(param1:Point, param2:String = "center") : int
      {
         ...
         var _loc4_:int = this.llv.indexOf(param1.y);
         if(_loc4_ == -1)
         {
            _loc4_ = param1.y < 0?0:int(_loc3_.numElements - 1);
         }
