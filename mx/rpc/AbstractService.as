package mx.rpc
{
   ...
   public dynamic class AbstractService extends Proxy implements IEventDispatcher
   {
      ...
      {
         var _loc3_:String = this.resourceManager.getString("rpc","operationsNotAllowedInService",[this.getLocalName(param1)]);
      ...
      override flash_proxy function nextNameIndex(param1:int) : int
      {
         ...
         return param1 < this.nextNameArray.length?int(param1 + 1):0;
      }
      ...
      public function getOperation(param1:String) : AbstractOperation
      {
         ...
         var _loc3_:AbstractOperation = _loc2_ is AbstractOperation?AbstractOperation(_loc2_):null;
         return _loc3_;
      }
