package mx.containers.utilityClasses
{
   ...
   public class BoxLayout extends Layout
   {
      ...
      override public function measure() : void
      {
         ...
         while(_loc9_ < _loc7_)
         {
            _loc12_ = _loc1_.getLayoutChildAt(_loc9_);
         ...
         _loc10_ = this.widthPadding(_loc8_);
         _loc11_ = this.heightPadding(_loc8_);
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc8_:Number = this.getHorizontalAlignValue();
         var _loc9_:Number = this.getVerticalAlignValue();
         ...
         if(_loc4_ == 1)
         {
            _loc23_ = _loc3_.getLayoutChildAt(0);
         ...
         else if(this.isVertical())
         {
            ...
            while(_loc21_ < _loc4_)
            {
               _loc22_ = _loc3_.getLayoutChildAt(_loc21_);
      ...
      mx_internal function widthPadding(param1:Number) : Number
      {
         ...
         if(param1 > 1 && this.isVertical() == false)
         {
