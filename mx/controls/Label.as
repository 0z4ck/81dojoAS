package mx.controls
{
   ...
   public class Label extends UIComponent implements IDataRenderer, IDropInListItemRenderer, IListItemRenderer, IFontContextComponent
   {
      ...
      override protected function measure() : void
      {
         ...
         _loc1_ = this.getMinimumText(_loc1_);
         var _loc2_:Rectangle = this.measureTextFieldBounds(_loc1_);
         measuredMinWidth = measuredWidth = _loc2_.width + getStyle("paddingLeft") + getStyle("paddingRight");
         measuredMinHeight = measuredHeight = _loc2_.height + getStyle("paddingTop") + getStyle("paddingBottom");
      }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.truncateToFit)
         {
            ...
            {
               this.textField.text = this._text;
               _loc9_ = Boolean(this.textField.truncateToFit());
            }
            if(!this.toolTipSet)
            {
      ...
      private function measureTextFieldBounds(param1:String) : Rectangle
      {
         ...
         return new Rectangle(0,0,_loc2_.width + UITextField.TEXT_WIDTH_PADDING,_loc2_.height + UITextField.TEXT_HEIGHT_PADDING);
      }
