package mx.controls
{
   ...
   public class ColorPicker extends ComboBase
   {
      ...
      mx_internal function displayDropdown(param1:Boolean, param2:Event = null) : void
      {
         ...
         {
            this.getDropdown();
            _loc8_ = new Point(layoutDirection == LayoutDirection.RTL?Number(this.dropdownSwatch.getExplicitOrMeasuredWidth()):Number(0),0);
         ...
         {
            _loc3_ = 0;
            _loc4_ = !!this.dropdownSwatch.tweenUp?Number(-this.dropdownSwatch.height / scaleY):Number(this.dropdownSwatch.height / scaleY);
            this.isDown = false;
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         else if(this.showingDropdown && _loc3_ == Keyboard.ENTER && this.dropdownSwatch.enabled)
         {
         ...
         else if(this.showingDropdown && (_loc3_ == Keyboard.HOME || _loc3_ == Keyboard.END || _loc3_ == Keyboard.PAGE_UP || _loc3_ == Keyboard.PAGE_DOWN || _loc3_ == Keyboard.LEFT || _loc3_ == Keyboard.RIGHT || _loc3_ == Keyboard.UP || _loc3_ == Keyboard.DOWN))
         {
