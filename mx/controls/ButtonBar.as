package mx.controls
{
   ...
   public class ButtonBar extends NavBar implements IFocusManagerComponent
   {
      ...
      public function ButtonBar()
      {
         ...
         addEventListener("scaleXChanged",this.scaleChangedHandler);
         addEventListener("scaleYChanged",this.scaleChangedHandler);
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(_loc2_ || param1 == this.buttonStyleNameProp || param1 == this.firstButtonStyleNameProp || param1 == this.lastButtonStyleNameProp)
         {
            this.resetNavItems();
         }
         else if(param1 == this.buttonWidthProp)
         {
            this.recalcButtonWidths = true;
         }
         else if(param1 == this.buttonHeightProp)
         {
            this.recalcButtonHeights = true;
         }
         else if(styleManager.isInheritingStyle(param1) && styleManager.isSizeInvalidatingStyle(param1))
         {
            this.recalcButtonWidths = this.recalcButtonHeights = true;
         }
      }
      ...
      override protected function commitProperties() : void
      {
         ...
         if(this.recalcButtonHeights)
         {
            this.resetButtonHeights();
         }
         if(this.recalcButtonWidths)
         {
      ...
      override protected function measure() : void
      {
         ...
         measuredWidth = this.calcFullWidth() + _loc1_.left + _loc1_.right;
         measuredHeight = this.calcFullHeight() + _loc1_.top + _loc1_.bottom;
         if(getStyle(this.buttonWidthProp))
         {
            measuredMinWidth = measuredWidth;
         }
         if(getStyle(this.buttonHeightProp))
         {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc4_:* = !_loc3_;
         var _loc5_:Number = getStyle(this.buttonWidthProp);
         var _loc6_:Number = getStyle(this.buttonHeightProp);
         ...
         if(param1 != this.oldUnscaledWidth)
         {
            this.recalcButtonWidths = true;
            this.oldUnscaledWidth = param1;
         }
         if(param2 != this.oldUnscaledHeight)
         {
            this.recalcButtonHeights = true;
         ...
         if(this.recalcButtonWidths)
         {
            this.recalcButtonWidths = false;
            if(isNaN(_loc5_) && _loc4_)
            {
               _loc5_ = _loc14_;
            }
            _loc18_ = _loc14_ - (this.calcFullWidth() - _loc12_);
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(isNaN(_loc17_.explicitWidth))
               {
                  ...
                  else if(_loc18_ < 0)
                  {
                     ...
                     _loc17_.percentWidth = _loc24_ / _loc14_ * 100;
                  }
                  else if(_loc18_ > 0)
                  {
         ...
         if(this.recalcButtonHeights)
         {
            this.recalcButtonHeights = false;
            if(isNaN(_loc7_) && _loc3_)
            {
               _loc7_ = _loc15_;
            }
            _loc18_ = _loc15_ - (this.calcFullHeight() - _loc13_);
            _loc25_ = 0;
            if(_loc18_ != 0 && _loc4_)
            {
               _loc16_ = 0;
      ...
      {
         this.drawButtonFocus(this.focusedIndex,param1);
      }
      ...
      override protected function resetNavItems() : void
      {
         ...
         var _loc1_:String = getStyle(this.buttonStyleNameProp);
         var _loc2_:String = getStyle(this.firstButtonStyleNameProp);
         var _loc3_:String = getStyle(this.lastButtonStyleNameProp);
         if(!_loc1_)
         {
      ...
      private function calcFullWidth() : Number
      {
         ...
         var _loc4_:Number = getStyle(this.buttonWidthProp);
      ...
      private function calcFullHeight() : Number
      {
         ...
         var _loc4_:Number = getStyle(this.buttonHeightProp);
         var _loc5_:IUIComponent = IUIComponent(getChildAt(0));
         if(_loc4_)
         {
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         var _loc2_:uint = mapKeycodeForLayoutDirection(param1,true);
         switch(_loc2_)
         {
            case Keyboard.DOWN:
            case Keyboard.RIGHT:
               focusManager.showFocusIndicator = true;
               this.drawButtonFocus(this.focusedIndex,false);
               this.focusedIndex = this.nextIndex(this.focusedIndex);
               if(this.focusedIndex != -1)
               {
                  this.drawButtonFocus(this.focusedIndex,true);
               }
            ...
            case Keyboard.LEFT:
               focusManager.showFocusIndicator = true;
               this.drawButtonFocus(this.focusedIndex,false);
               this.focusedIndex = this.prevIndex(this.focusedIndex);
               if(this.focusedIndex != -1)
               {
                  this.drawButtonFocus(this.focusedIndex,true);
               }
            ...
            case Keyboard.SPACE:
               if(this.focusedIndex != -1)
               {
                  _loc3_ = Button(getChildAt(this.focusedIndex));
      ...
      override protected function keyUpHandler(param1:KeyboardEvent) : void
      {
         ...
         switch(param1.keyCode)
         {
            case Keyboard.SPACE:
               if(this.focusedIndex != -1)
               {
                  _loc2_ = Button(getChildAt(this.focusedIndex));
      ...
      {
         if(this.simulatedClickTriggerEvent == null)
         {
            this.focusedIndex = getChildIndex(DisplayObject(param1.currentTarget));
            this.drawButtonFocus(this.focusedIndex,true);
         }
      ...
      private function childRemoveHandler(param1:ChildExistenceChangedEvent) : void
      {
         ...
         var _loc5_:String = getStyle(this.buttonStyleNameProp);
         var _loc6_:String = getStyle(this.firstButtonStyleNameProp);
         var _loc7_:String = getStyle(this.lastButtonStyleNameProp);
         if(!_loc5_)
         {
