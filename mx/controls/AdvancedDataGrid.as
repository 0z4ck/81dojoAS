package mx.controls
{
   ...
   public class AdvancedDataGrid extends AdvancedDataGridBaseEx
   {
      ...
      override protected function drawRowBackgrounds() : void
      {
         ...
         var _loc10_:int = 0;
         _loc1_ = getStyle("depthColors");
         if(!(this._rootModel is IHierarchicalData) || !_loc1_)
         {
            super.drawRowBackgrounds();
            return;
         }
         var _loc2_:Sprite = Sprite(listContent.getChildByName("rowBGs"));
         if(!_loc2_)
         {
            _loc2_ = new FlexSprite();
            _loc2_.mouseEnabled = false;
            _loc2_.name = "rowBGs";
            listContent.addChildAt(_loc2_,0);
         }
         ...
         else
         {
            ...
            if(_loc9_)
            {
               _loc1_ = _loc9_ is Array?_loc9_ as Array:[_loc9_];
            }
         }
         ...
         styleManager.getColorNames(_loc1_);
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:int = verticalScrollPosition;
         while(_loc6_ < _loc5_)
         {
            if(_loc4_)
            {
               try
               {
                  ...
                  {
                     _loc10_ = this.getItemDepth(listItems[_loc6_][0].data,_loc6_);
                     drawRowBackground(_loc2_,_loc7_++,rowInfo[_loc6_].y,rowInfo[_loc6_].height,_loc1_[_loc10_ - 1],_loc6_);
                  }
                  else
                  {
                     drawRowBackground(_loc2_,_loc7_++,rowInfo[_loc6_].y,rowInfo[_loc6_].height,uint(_loc3_),_loc6_);
                  }
               }
               catch(e:Error)
               {
            ...
            {
               drawRowBackground(_loc2_,_loc7_++,rowInfo[_loc6_].y,rowInfo[_loc6_].height,_loc1_[_loc8_ % _loc1_.length],_loc8_);
            }
            _loc6_++;
            _loc8_++;
         }
      ...
      override public function itemToIcon(param1:Object) : Class
      {
         ...
         var _loc6_:Class = this.itemIcons && this.itemIcons[_loc5_]?this.itemIcons[_loc5_][!!_loc3_?"iconID2":"iconID"]:null;
         if(_loc6_)
         {
            return _loc6_;
         }
      ...
      override protected function getHeaderItemsLength() : int
      {
         ...
         {
            return this.headerItemsList.length;
         }
         return 0;
      }
