package mx.controls.alertClasses
{
   ...
   public class AlertForm extends UIComponent implements IFontContextComponent
   {
      ...
      override protected function measure() : void
      {
         ...
         if(this.icon)
         {
            _loc6_ = _loc6_ + (this.icon.width + 8);
         }
         ...
         _loc7_ = _loc7_ + (this.buttons[0].height + 3 * 8);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         while(_loc6_ < this.buttons.length)
         {
            ...
            _loc3_ = _loc3_ + (this.buttons[_loc6_].width + 8);
            _loc6_++;
         }
         _loc5_ = this.textWidth;
         if(this.icon)
         {
            _loc5_ = _loc5_ + (this.icon.width + 8);
         }
         _loc3_ = Math.round((param1 - _loc5_) / 2);
         if(this.icon)
         {
            ...
            _loc3_ = _loc3_ + (this.icon.width + 8);
         }
