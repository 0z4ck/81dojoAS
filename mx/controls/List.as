   ...
   public class List extends ListBase implements IIMESupport
   {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(itemsNeedMeasurement)
         {
            ...
            {
               setColumnWidth(this.measureWidthOfItems(0,explicitRowCount < 1?int(defaultRowCount):int(explicitRowCount)));
            }
         }
      }
      ...
      override protected function configureScrollBars() : void
      {
         ...
         var _loc11_:int = !!collection?int(collection.length - this.lockedRowCount):0;
      ...
      override protected function drawRowBackgrounds() : void
      {
         ...
         while(_loc4_ < _loc7_)
         {
            this.drawRowBackground(_loc1_,_loc6_++,rowInfo[_loc4_].y,rowInfo[_loc4_].height,_loc2_[_loc5_ % _loc2_.length],_loc5_);
            _loc4_++;
            _loc5_++;
         }
         while(_loc1_.numChildren > _loc7_)
