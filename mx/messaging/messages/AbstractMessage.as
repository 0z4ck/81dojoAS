package mx.messaging.messages
{
   ...
   public class AbstractMessage implements IMessage
   {
      ...
      public function writeExternal(param1:IDataOutput) : void
      {
         ...
         if(this.body != null)
         {
            _loc2_ = _loc2_ | BODY_FLAG;
         }
         if(this.clientId != null && this.clientIdBytes == null)
         {
            _loc2_ = _loc2_ | CLIENT_ID_FLAG;
         }
         if(this.destination != null)
         {
            _loc2_ = _loc2_ | DESTINATION_FLAG;
         }
         if(this.headers != null)
         {
            _loc2_ = _loc2_ | HEADERS_FLAG;
         }
         if(this.messageId != null && this.messageIdBytes == null)
         {
            _loc2_ = _loc2_ | MESSAGE_ID_FLAG;
         }
         if(this.timestamp != 0)
         {
            _loc2_ = _loc2_ | TIMESTAMP_FLAG;
         }
         if(this.timeToLive != 0)
         {
            _loc2_ = _loc2_ | TIME_TO_LIVE_FLAG;
         }
         if(this.clientIdBytes != null || this.messageIdBytes != null)
         {
            _loc2_ = _loc2_ | HAS_NEXT_FLAG;
         }
         param1.writeByte(_loc2_);
         _loc2_ = 0;
         if(this.clientIdBytes != null)
         {
            _loc2_ = _loc2_ | CLIENT_ID_BYTES_FLAG;
         }
         if(this.messageIdBytes != null)
         {
            _loc2_ = _loc2_ | MESSAGE_ID_BYTES_FLAG;
         }
         if(_loc2_ != 0)
         {
            param1.writeByte(_loc2_);
      ...
      protected final function getDebugString() : String
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            ...
            _loc1_ = _loc1_ + RPCStringUtil.substitute("\n  {0}={1}",_loc6_,_loc7_);
            _loc5_++;
         }
         return _loc1_;
      }
