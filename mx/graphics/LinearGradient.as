package mx.graphics
{
   ...
   public class LinearGradient extends GradientBase implements IFill
   {
      ...
      public function begin(param1:Graphics, param2:Rectangle, param3:Point) : void
      {
         ...
         if(!compoundTransform)
         {
            ...
            if(isNaN(_loc6_))
            {
               if(rotation % 90 != 0)
               {
                  ...
                  _loc10_ = Math.acos(param2.width / _loc9_) * 180 / Math.PI;
                  if(_loc7_ > _loc10_)
                  {
                     _loc7_ = 90 - _loc7_;
               ...
               {
                  _loc6_ = rotation % 180 == 0?Number(param2.width):Number(param2.height);
               }
            }
         ...
         param1.beginGradientFill(GradientType.LINEAR,colors,alphas,ratios,commonMatrix,spreadMethod,interpolationMethod);
      }
