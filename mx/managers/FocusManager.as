package mx.managers
{
   ...
   public class FocusManager extends EventDispatcher implements IFocusManager
   {
      ...
      public function FocusManager(param1:IFocusManagerContainer, param2:Boolean = false)
      {
         ...
         this.desktopMode = Capabilities.playerType == "Desktop" && !param2;
            ...
            if(this.isValidFocusCandidate(this.focusableCandidates[param1],param4))
            {
               ...
               if(_loc7_ is IFocusManagerGroup)
               {
                  ...
                  while(_loc9_ < this.focusableCandidates.length)
                  {
                     ...
                     if(_loc10_ is IFocusManagerGroup && this.isEnabledAndVisible(_loc10_))
                     {
      ...
      {
         return this.getNextFocusManagerComponent2(param1,this.fauxFocus).displayObject as IFocusManagerComponent;
      }
