package mx.managers
{
   ...
   public class PopUpManagerImpl extends EventDispatcher implements IPopUpManager
   {
      ...
      public function centerPopUp(param1:IFlexDisplayObject) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_4_0)
            {
               ...
               if(_loc19_ && (_loc20_ && _loc20_.layoutDirection != _loc19_.layoutDirection || !_loc20_ && _loc19_.layoutDirection == LayoutDirection.RTL))
               {
      ...
      mx_internal function hideModalWindow(param1:PopUpData, param2:Boolean = false) : void
      {
         ...
         {
            _loc8_ = new DynamicEvent("hideModalWindow",false,false);
            _loc8_.popUpData = param1;
