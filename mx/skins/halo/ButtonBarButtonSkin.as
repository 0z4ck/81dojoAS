package mx.skins.halo
{
   ...
   public class ButtonBarButtonSkin extends Border
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         {
            styleName.styleManager.getColorNames(_loc6_);
         }
         else
         {
            StyleManager.getStyleManager(null).getColorNames(_loc6_);
         }
         ...
         var _loc17_:Object = this.getCornerRadius(_loc16_,_loc15_,_loc4_);
         var _loc18_:Object = this.getCornerRadius(_loc16_,_loc15_,_loc4_);
         var _loc19_:Object = this.getCornerRadius(_loc16_,_loc15_,_loc4_ - 1);
         var _loc20_:Object = this.getCornerRadius(_loc16_,_loc15_,_loc4_ - 2);
         var _loc21_:Object = this.getCornerRadius(_loc16_,_loc15_,_loc4_ - 3);
         graphics.clear();
         switch(name)
         {
            case "selectedUpSkin":
