package mx.skins.halo
{
   ...
   public class ScrollArrowSkin extends Border
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc12_:Boolean = parent && parent.parent && parent.parent.rotation != 0;
         if(_loc9_ && !_loc12_)
         {
         ...
         switch(name)
         {
            ...
            case "downArrowUpSkin":
               ...
               drawRoundRect(1,1,param1 - 2,param2 - 2,0,_loc15_,_loc16_,!!_loc12_?horizontalGradientMatrix(0,0,param1 - 2,param2 - 2):verticalGradientMatrix(0,0,param1 - 2,param2 - 2 / 2));
               drawRoundRect(1,1,param1 - 2,param2 - 2 / 2,0,[16777215,16777215],_loc7_,!!_loc12_?horizontalGradientMatrix(0,0,param1 - 2,param2 - 2):verticalGradientMatrix(0,0,param1 - 2,param2 - 2 / 2));
               break;
            ...
            case "downArrowDisabledSkin":
               ...
               drawRoundRect(1,1,param1 - 2,param2 - 2,0,_loc19_,_loc20_,!!_loc12_?horizontalGradientMatrix(0,0,param1 - 2,param2 - 2):verticalGradientMatrix(0,0,param1 - 2,param2 - 2 / 2));
