package mx.effects.effectClasses
{
   ...
   public class MoveInstance extends TweenEffectInstance
   {
      ...
      override public function play() : void
      {
         ...
         if(isNaN(this.xFrom))
         {
            this.xFrom = !isNaN(this.xTo) && !isNaN(this.xBy)?Number(this.xTo - this.xBy):Number(target.x);
         }
         if(isNaN(this.xTo))
         {
         ...
         if(isNaN(this.yFrom))
         {
            this.yFrom = !isNaN(this.yTo) && !isNaN(this.yBy)?Number(this.yTo - this.yBy):Number(target.y);
         }
         if(isNaN(this.yTo))
         {
