package mx.collections
{
   ...
   public class SortField extends EventDispatcher implements ISortField
   {
      ...
      private function numericCompare(param1:Object, param2:Object) : int
      {
         ...
         try
         {
            _loc3_ = this._name == null?Number(Number(param1)):Number(Number(param1[this._name]));
         }
         catch(error:Error)
         {
         }
         try
         {
            _loc4_ = this._name == null?Number(Number(param2)):Number(Number(param2[this._name]));
         }
         catch(error:Error)
         {
         }
