      ...
      public function collectionChangeHandler(param1:CollectionEvent) : void
      {
         ...
         if(param1.kind == CollectionEventKind.ADD)
         {
            ...
            while(_loc2_ < _loc3_)
            {
               ...
               if(_loc9_)
               {
                  ...
                  _loc10_ = this.collection.getChildren(_loc5_);
                  if(_loc5_ == _loc6_)
                  {
                     if(_loc10_ != null)
                     {
                        ...
                        try
                        {
                           _loc11_.seek(this.currentChildBookmark);
                           _loc11_.moveNext();
                           this.currentChildBookmark = _loc11_.bookmark;
                        }
                        catch(e:ItemPendingError)
                        {
                        }
                  ...
                  else if(_loc8_[_loc5_] != null)
                  {
                     if(_loc10_ != null)
                     {
                        ...
                        this.childIndexStack[_loc8_[_loc5_]] = this.currentChildBookmark;
                     }
                  }
               }
               _loc2_++;
         ...
         else if(param1.kind == CollectionEventKind.REMOVE)
         {
            ...
            if(param1.location <= this.currentIndex)
            {
               ...
               {
                  _loc12_ = param1.location;
                  this.moveToFirst();
                  this.seek(CursorBookmark.FIRST,_loc12_);
                  _loc2_ = 0;
                  while(_loc2_ < _loc3_)
                  {
                     _loc4_ = param1.items[_loc2_];
                     delete this.collection.parentMap[UIDUtil.getUID(_loc4_)];
                     _loc2_++;
                  }
                  return;
               }
